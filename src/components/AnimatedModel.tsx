...
export function AnimatedModel({ path, scale = 1, motionConfig, isMobile }: AnimatedModelProps) {
  ...
  const rZ = useTransform(scrollYProgress, [0, 1], rotZ);
  ...
  useFrame(() => {
    ...
    modelRef.current.rotation.set(rX.get(), rY.get(), rZ.get());
